...
import static com.teamez.wifidirecttest.R.id;
import static com.teamez.wifidirecttest.R.layout;
...
public class DeviceListAdapter extends RecyclerView.Adapter<DeviceListAdapter.DeviceViewHolder> {
    ...
    void removeElement (DeviceInfo element) {
        mDeviceList.remove(element);
        notifyDataSetChanged();
    }
